...
function buildMarkdownDoc(md) {
  ...
  return '<!DOCTYPE html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1">'+MARKDOWN_STYLE+'<script src="https://cdn.jsdelivr.net/npm/marked/marked.min.js"><\\/script></head><body><div id="content"></div><script type="text/markdown" id="md-source">'+safeMd+'<\\/script><script>var src=document.getElementById("md-source").textContent;document.getElementById("content").innerHTML=marked.parse(src,{breaks:true,gfm:true})<\\/script></body></html>';
}
